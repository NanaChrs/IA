...
var joie = function(deformPoints,coeff) {
    coeff=coeff/100;
...
var colere = function(deformPoints,coeff) {
    coeff=coeff*(3/100);
...
var surprise = function(deformPoints,coeff){
    coeff=coeff/100;
...
var triste = function(deformPoints,coeff) {
    coeff=coeff/50;
